...
import artistImage from './assets/images/Purshotam.jpeg';
            ...
            <div style={styles.artistsContainer}>
                ...
                <div style={styles.info}>
                    ...
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>IPod.js <span><img style={styles.image} src="https://cdn-icons-png.flaticon.com/128/478/478809.png" /></span></h4>
                        <p style={{marginBottom:'0'}}> React Project</p>
                        <p>Made by : Purshotam</p>
                    </div>
